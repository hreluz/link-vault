...
export default function QuickCaptureClient() {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-8">
      ...
      <h1 className="mb-2 text-2xl font-bold text-slate-900 dark:text-slate-50">Quick Capture</h1>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700">
        ...
        {href && (
          <a
            ...
            className="inline-flex cursor-grab items-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500 active:cursor-grabbing"
          >
            🔖 Save to Link Vault
          </a>
        )}
      ...
      <div className="mt-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700">
        <p className="mb-2 text-sm font-medium text-slate-700 dark:text-slate-300">On iOS Safari</p>
        ...
        {href && (
          <textarea
            ...
            rows={4}
            className="mt-3 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 font-mono text-xs text-slate-600 outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
          />
        )}
      </div>
    </main>
